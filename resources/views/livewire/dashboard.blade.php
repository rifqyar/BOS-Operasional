    ...
    <div class="min-h-[calc(100vh-5rem)] bg-slate-50 pb-24 text-slate-950 dark:bg-slate-950 dark:text-white lg:pb-6">
        <div class="mx-auto flex w-full max-w-7xl flex-col gap-5 px-4 py-4 sm:px-6 lg:px-8">
            ...
            <section
                ...
                <div @class([
                    'mx-auto grid w-full max-w-5xl grid-cols-3 gap-3 lg:grid-cols-6 lg:gap-4',
                    'hidden' => $activePanel,
                ]) data-handheld-menu>
                    <a href="{{ route('pickup') }}" wire:navigate data-open-pickup
                        ...
                        <span
                            class="flex size-10 items-center justify-center rounded-md bg-sky-700 text-white shadow-sm transition group-hover:bg-sky-800">
                            <flux:icon.truck class="size-5" />
                        </span>
                        <span class="text-xs font-bold uppercase leading-tight sm:text-sm">Pick Up</span>
                    </a>

                    <a href="{{ route('behandlein') }}" wire:navigate
                    ...
                    <a href="#"
                        ...
                        <span
                            class="flex size-10 items-center justify-center rounded-md bg-slate-100 text-rose-700 transition group-hover:bg-rose-600 group-hover:text-white dark:bg-white/10 dark:text-rose-200">
