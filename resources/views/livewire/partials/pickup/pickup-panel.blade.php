<div class="mx-auto mb-5 max-w-3xl"
    data-pickup-panel
    data-pickup-search-url="{{ route('pickup.search') }}"
    data-pickup-store-url="{{ route('pickup.store') }}"
    ...
    <form data-pickup-search-form
        class="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
        <label for="pickup-no-spk" class="text-sm font-semibold text-slate-700 dark:text-slate-200">Nomor SPK</label>
        <div class="mt-2 grid gap-3 sm:grid-cols-[1fr_auto]">
            <div class="relative">
                ...
                <input id="pickup-no-spk" name="no_spk" type="text" autocomplete="off"
            ...
            <button type="submit" data-pickup-search-button
    ...
    <div class="mt-4 hidden overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-slate-950" data-pickup-result>
        <div class="border-b border-slate-200 bg-slate-50 px-4 py-3 dark:border-white/10 dark:bg-white/5">
            ...
            <p class="mt-1 text-base font-semibold text-slate-950 dark:text-white" data-pickup-result-spk>-</p>
        </div>
        ...
        <div class="divide-y divide-slate-200 dark:divide-white/10" data-pickup-rows></div>
    </div>
</div>
