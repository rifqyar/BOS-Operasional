<div
    ...
    data-panel
    data-panel-name="monitoringreefer"
    data-search-url="{{ route('monitoringreefer.search') }}"
    data-store-url="{{ route('monitoringreefer.store') }}"
