<div
    ...
    data-panel
    data-panel-name="onchassis"
    data-search-url="{{ route('onchassis.search') }}"
    data-store-url="{{ route('onchassis.store') }}"
    ...
    <div class="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <span class="w-fit rounded-md bg-sky-100 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-sky-700 dark:bg-sky-400/10 dark:text-sky-300">
            On Chassis
        </span>
    </div>
